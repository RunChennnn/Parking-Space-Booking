import { Card, Checkbox, FormControl, FormControlLabel, InputLabel, MenuItem, Select, TextField } from '@mui/material';
  ...
  return (
    <>
      <Card style={cardStyle}>
        ...
        <div>{'Revenue will be paid to the following card. Please note, 15% of revenue from each booking will be deducted as a service fee.'}</div>
